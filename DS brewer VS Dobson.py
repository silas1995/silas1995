...
# Plot DS from the second dataset (complete line graph)
plt.plot(weekly_df2['Date'], weekly_df2['Dobson Weekly_Average_DS'], label='Weekly Average DS (Dobson)', color='r')
plt.plot(weekly_df2['Date'], weekly_df2['Dobson Weekly_Average_DS'], color='r', marker='x', linestyle='--')

# Plot ZC from the second dataset (complete line graph)
#plt.plot(weekly_df2['Date'], weekly_df2['Dobson Weekly_Average_ZC'], label='Weekly Average ZC (Dobson)', color='b')
#plt.plot(weekly_df2['Date'], weekly_df2['Dobson Weekly_Average_ZC'], color='b', marker='x', linestyle='--')
